            ...
            <div id="header" class="container">
                <div id="logo">
                    ...
                    <li><a href="interface_economicos.php" accesskey="1" title="">Econômicos</a></li>
                        <li><a href="/app/resources/views/categorias/interface_suv.php" accesskey="2" title="">SUV</a></li>
                        <li><a href="/app/resources/views/categorias/interface_utilitarios.php" accesskey="3" title="">Utilitários</a></li>
                        <li class="current_page_item"><a href="/app/resources/views/categorias/interface_luxo.php" accesskey="4" title="">Luxo</a></li>
                        </ul>
                        <br>
                    ...
                    #SQL para listagem
                    $query = "SELECT * FROM automovel WHERE tipo = 'Luxo'";
