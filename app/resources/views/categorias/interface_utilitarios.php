        ...
        <div id="header-wrapper">
            <div id="header" class="container">
                <div id="logo">
                    ...
                    <div id="menu">
                        <li><a href="/app/resources/views/carro/interface_economicos.php" accesskey="1" title="">Econômicos</a></li>
                        <li><a href="/app/resources/views/carro/interface_suv.php" accesskey="2" title="">SUV</a></li>
                        <li class="current_page_item"><a href="/app/resources/views/categorias/interface_utilitarios.php" accesskey="3" title="">Utilitários</a></li>
                        <li><a href="/app/resources/views/carro/interface_luxo.php" accesskey="4" title="">Luxo</a></li>
                        </ul>
                        <br>
								...
								<div id='portfolio' class='container_carros'>
									<div class='column10'>
										<div class='boxcar'>
											...
											<form enctype='multipart/form-data' method='POST' action='/app/resources/views/carro/alugar_carro.php' >							
