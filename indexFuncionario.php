		...
		<div id="header-wrapper">
			<div id="header" class="container">
				<div id="logo">
					...
					<h1><a href="#">Apuama - Sistema de Gerenciamento de Aluguel de Carros</a></h1>
					<div id="menu">
						<ul>
							<?php
								if($tipo = 'F'){
				...
				<div id="portfolio" class="container">
					...
					<div class="column1">
						<div class="box">
							...
							<form method="post" action="app/resources/views/carro/pesquisar_carros.php">
					...
					<div class="column2">
						<div class="box">
							...
							<form method="post" action="app/resources/views/carro/inserir_carros.php">
					...
					<div class="column4">
						<div class="box">
							...
							<form method="post" action="app/resources/views/clientes/pesquisa_cliente_via_funcionario.php">
					...
					<div class="column5">
						<div class="box">
							<span class="icon icon-laptop"></span>
							<form method="post" action="app/resources/views/carro/todos_mecanica.php">
